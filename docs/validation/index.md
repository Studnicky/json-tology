...
|--------|---------|----------|
| [`coerce`](./coerce) | `TMap[K]` (typed) | You want a typed, defaults-applied value or a typed exception |
...
| [`validateAt`](./validateAt) | `string[]` | You need to validate a sub-schema by JSON Pointer |
