 ...
 */
type ResolvedRefTargetWithGraphType = {
 ...
 */
type ResolvedRefTargetNoGraphType = {
 ...
 * (parseRef → resolveSchemaId → getSchema → getGraph → resolveFragment)
 ...
 */
export type ResolvedRefTargetType = ResolvedRefTargetNoGraphType | ResolvedRefTargetWithGraphType;
