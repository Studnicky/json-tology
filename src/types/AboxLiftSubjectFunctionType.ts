 ...
 * @example
 * ```ts
 * const lift: AboxLiftSubjectFunctionType = (classId: string, quads: QuadInterface[]) => registry.fromQuads(classId, quads);
 * ```
 *
 * @category Graph
 * @since 0.1.0
 ...
 * @group Graph
 */
export type AboxLiftSubjectFunctionType = (classId: string, quads: QuadInterface[]) => unknown[];
