 ...
 * ```
 */
import type { JsonTologyTypeConfigInterface } from '../interfaces/JsonTologyTypeConfig.js';

export type { JsonTologyTypeConfigInterface } from '../interfaces/JsonTologyTypeConfig.js';
