/**
 * ShaclValidationReportInterface — the top-level SHACL conformance report.
 *
 ...
 * @group Interfaces
 */
import type { ShaclValidationResultInterface } from './ShaclValidationResultInterface.js';

export interface ShaclValidationReportInterface {
  /**
   ...
   */
  readonly 'results': readonly ShaclValidationResultInterface[];
}
