...
function createImplicitDefaultValueInternal(
  ...
  if (typeof ref === 'string') {
    ...
    return createImplicitDefaultValueInternal(context, rNode, rGraph, dynamicScope, visited, depth + 1);
  }
  ...
  if (sem.schemaTypes.includes('object') || hasProperties) {
    ...
    for (const [
      ...
      const childValue = createImplicitDefaultValueInternal(
        context,
        childNode,
        graph,
        dynamicScope,
...
function synthesizeZeroValueInternal(
  ...
  if (typeof sem.ref === 'string') {
    ...
    return synthesizeZeroValueInternal(context, rNode, rGraph, dynamicScope, visited, depth + 1);
  }
...
export const GraphEngineDefaults = {
  createImplicitDefaultValue(
    ...
    return createImplicitDefaultValueInternal(context, node, graph, dynamicScope, new Set<string>(), 0);
  },
  ...
  createImplicitDefaultValueSeeded(
    ...
    return createImplicitDefaultValueInternal(context, node, graph, dynamicScope, visited, 0);
  },
  ...
  synthesizeZeroValue(
    ...
    return synthesizeZeroValueInternal(context, node, graph, dynamicScope, new Set<string>(), 0);
  }
} as const;
