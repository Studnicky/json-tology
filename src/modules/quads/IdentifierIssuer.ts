...
import type { IdentifierIssuerOptionsInterface } from '../../interfaces/IdentifierIssuerOptionsInterface.js';
...
export class IdentifierIssuer implements IdentifierIssuerInterface {
   ...
   *
   * @param options - Optional bag typed as {@link IdentifierIssuerOptionsInterface}:
   ...
   */
  constructor(options?: IdentifierIssuerOptionsInterface) {
