...
// ---------------------------------------------------------------------------
// Outer describe — counter closure
// All conformance suites live inside this describe so the counter starts at 0
// on every test run and there is no cross-run state dependence.
// ---------------------------------------------------------------------------

void describe('Compiler conformance', () => {
  // counter is scoped to this closure — resets to 0 each time the suite runs
  let counter = 0;
  ...
  void describe('Compiler conformance: basic types and multiple type unions', { 'concurrency': true }, () => {
    void it('basic types and union type scenarios all pass conformance', () => {
  ...
  void describe('Compiler conformance: object constraints', { 'concurrency': true }, () => {
    void it('required, additionalProperties, property counts, and patternProperties all pass conformance', () => {
  ...
  void describe('Compiler conformance: string and numeric constraints', { 'concurrency': true }, () => {
    void it('string length, pattern, and numeric boundary constraints all pass conformance', () => {
  ...
  void describe('Compiler conformance: enum, const, and composition keywords', { 'concurrency': true }, () => {
    void it('enum, const, anyOf, oneOf, and not scenarios all pass conformance', () => {
    ...
    void describe('allOf composition', { 'concurrency': true }, () => {
      void it('allOf scenarios: satisfied, missing required, empty object all pass conformance', () => {
  ...
  void describe('Compiler conformance: array keywords and contains', { 'concurrency': true }, () => {
    void it('array items, prefixItems, bounds, uniqueItems, and contains all pass conformance', () => {
  ...
  void describe('Compiler conformance: $ref, if/then/else, and dependentRequired', { 'concurrency': true }, () => {
    void it('$ref (local and cross-schema), if/then/else, dependentRequired, and nested $ref all pass conformance', () => {
      // $ref with $defs (local)
  ...
  void describe('Compiler conformance: format and custom keywords', { 'concurrency': true }, () => {
    void it('format validation scenarios pass conformance', () => {
    ...
    void describe('custom keyword evenNumber', { 'concurrency': true }, () => {
      ...
      void it('custom keyword evenNumber and schema compiles without fallback', () => {
    ...
    void describe('discriminator mapping', { 'concurrency': true }, () => {
      void it('discriminator routing scenarios pass conformance', () => {
  ...
  // end: Compiler conformance: format and custom keywords
});
// end: Compiler conformance (outer closure)
